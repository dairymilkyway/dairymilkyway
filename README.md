...
A passionate developer who loves turning complex problems into simple, beautiful, and efficient solutions. I thrive on learning new technologies and leveraging my design skills to create better user experiences across **web and mobile platforms**.

---

## 📌 About Me

- 💻 I specialize in **Full-Stack Web Development (MERN)** and **Cross-Platform Mobile Engineering (React Native & Flutter)**.
- 🚀 I’m currently focused on scaling applications with **.NET** and enhancing UIs using **DaisyUI**.
- 🌱 I'm expanding my knowledge in **cloud deployment** and **automated workflows**.
- 👯 I’m open to collaborating on projects involving **mobile app development, open-source web tools, or any project that mixes coding with multimedia design**.
...
I use a versatile stack to deliver high-quality, full-stack solutions:
